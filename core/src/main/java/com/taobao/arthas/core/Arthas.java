...
public class Arthas {
    ...
    public static void main(String[] args) {
        try {
            args = new String[]{"-pid", "67040", "-target-ip", "127.0.0.1", "-telnet-port", "3658", "-http-port", "8563", "-core", " C:\\Users\\DELL\\.arthas\\lib\\3.3.6\\arthas\\arthas-core.jar", "-agent", "C:\\Users\\DELL\\.arthas\\lib\\3.3.6\\arthas\\arthas-agent.jar"};
            new Arthas(args);
        } catch(Throwable t){
